...
<section class="campagne">
            <div class="campagne__wrapup">
                ...
                <div class="campagne__wrapup__contenus">
                    <h2 class="anim_titre_campagne">CAMPAGNE DE LEVÉE
                        DE FONDS</h2>
                    <p class="anim_contenu_campagne">Il y a quelques semaines, nous avons fêté nos 30 ans. Pour notre anniversaire, on a soufflé des
                        chandelles…et la maison a brûlé.
                        Aidez-nous à maintenir nos activités et accueillir nos Impatients.</p>
                    <button class="anim_bouton_campagne">Pour donner ></button>
                </div>
            </div>
        </section>
        <!------------------------FIN CAMPAGNE------------------------->
